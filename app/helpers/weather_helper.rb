module WeatherHelper
  ...
  def parse_location
    url_location = 'http://api.db-ip.com/v2/c19b3558fbbf6b72dffdb99cf85'\
"139c7fe0663e7/#{request.ip}"
    JSON.parse(Net::HTTP.get(URI(url_location)))['city']
  end

  def weather_json
    city = parse_location
    url_weather = "http://api.openweathermap.org/data/2.5/forecast?q=#{city}&"\
'mode=json&appid=172d1d74437e766c4bd5cde75c58e0da'
